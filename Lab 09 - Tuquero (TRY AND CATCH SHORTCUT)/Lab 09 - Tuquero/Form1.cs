...
namespace Lab_09___Tuquero
{
    public partial class Form1 : Form
    {
        ...
        private decimal decTransactionAmount = 0M;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Invalid Number of Room(s)", "Data Error");
                txtRooms.Focus();
                txtRooms.SelectAll();
                return;
            }
            ...
            {
                MessageBox.Show("Invalid Number of Nights", "Data Error");
                txtNights.Focus();
                txtNights.SelectAll();
                return;
            }
            ...
            {
                MessageBox.Show("Invalid Number of Adult(s)", "Data Error");
                txtAdults.Focus();
                txtAdults.SelectAll();
                return;
            }
            ...
            {
                MessageBox.Show("Invalid Number of Children", "Data Error");
                txtChildren.Focus();
        ...
        private void btnSummary_Click(object sender, EventArgs e)
        {
             ...
             MessageBox.Show("\n Total Transaction: " + intTotalTransaction +
                              ...
                              "\n Transaction Amount: " + decTransactionAmount.ToString("N2"),
